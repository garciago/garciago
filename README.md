...
**Diretor de TI** com **+20 anos de experiência** em transformação digital, infraestrutura de missão crítica e liderança de equipes de alta performance no setor financeiro.

- 🏢 Atualmente **Diretor de Operações de TI** no **Grupo Nexxera**
...
| **Bancos Conectados** | 80+ instituições |
| **Uptime de Sistemas** | 99.95%+ |
...
- **Infraestrutura Hiperconvergente Nutanix** - Migração para nuvem híbrida com +60% de performance
- **Migração Oracle RAC → Exadata** - 3x mais capacidade, 70% menos latência
- **OpenShift Enterprise** - Deploys diários automatizados (antes: semanais)
...
- **LGPD** - Adequação completa às normas de proteção de dados
- **100% de aprovação** em auditorias de bancos e operadoras de cartão

### 🏠 Resposta à Pandemia
- **Home Office em <48h** - Toda a empresa trabalhando remotamente de forma segura
...
**💬 Me envie uma mensagem no [LinkedIn](https://www.linkedin.com/in/thiago-garcia-5a803466/)!**

---

![Profile Views](https://komarev.com/ghpvc/?username=garciago&color=blue&style=flat-square)
